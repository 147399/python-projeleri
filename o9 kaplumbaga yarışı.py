import math
import random
import turtle      # kütuphaneleri tanımladık
#import time

win_length = 500       # uzunlugumuz
win_height = 500

turtles = 8        # kaplumbaga sayısı

turtle.screensize(win_length, win_height)          # kaplumbaga  boyutları


class racer(object):                                # objelerin tanımları
